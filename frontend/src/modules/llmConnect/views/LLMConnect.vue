  ...
  <div class="p-6 space-y-6 text-white">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
      <div class="bg-white/5 border border-white/10 rounded-lg p-4 flex flex-col gap-3">
        <div class="flex items-center justify-between">
          <div>
            <p class="font-semibold text-white">Agents</p>
            <p class="text-xs text-gray-400">Manage available LLM personas</p>
          </div>
          <button
      ...
      <div class="bg-white/5 border border-white/10 rounded-lg p-4 flex flex-col gap-3 md:col-span-2">
        <div class="flex items-center justify-between">
          <div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-3">
          <div class="space-y-2 max-h-80 overflow-y-auto lg:col-span-1">
            <div
          ...
          <div class="lg:col-span-2">
            ...
            <div class="space-y-3">
              <div class="flex items-center gap-2">
                ...
                />
                <button
                  class="px-3 py-2 text-xs font-bold text-white bg-neon-purple/60 rounded hover:bg-neon-purple/80 disabled:opacity-40"
              ...
              <div class="h-72 border border-white/10 rounded-lg p-3 bg-black/30 overflow-y-auto space-y-3">
                <div
